    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.vitrine.testimonials.store') }}" class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label">Photo parent (URL)</label><input type="text" name="parent_photo_url" class="form-control" placeholder="https://..."></div>
            ...
            @foreach($testimonials as $testimonial)
                <div class="border rounded p-2 mb-2">
                    <form method="POST" action="{{ route('admin.vitrine.testimonials.update', $testimonial) }}" class="row g-2">
                        ...
                        <div class="col-md-4"><input type="text" name="parent_photo_url" class="form-control form-control-sm" value="{{ $testimonial->parent_photo_url }}" placeholder="Photo parent URL"></div>
