...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100"><div class="card-body"><div class="text-muted small">Comptes verifies</div><div class="display-6 fw-semibold">{{ $stats['verified_accounts'] ?? 0 }}</div></div></div>
        </div>
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100"><div class="card-body"><div class="text-muted small">Non verifies</div><div class="display-6 fw-semibold">{{ $stats['not_verified_accounts'] ?? 0 }}</div></div></div>
        </div>
        <div class="col-lg-3 col-md-6 mb-3">
