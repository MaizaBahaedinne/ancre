                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="file" name="cin_recto" class="form-control-file @error('cin_recto') is-invalid @enderror" required>
                                @error('cin_recto') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 form-group">
                                <label>CIN Verso (image ou PDF)</label>
                                <input type="file" name="cin_verso" class="form-control-file @error('cin_verso') is-invalid @enderror" required>
